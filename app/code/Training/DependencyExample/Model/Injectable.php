...
//  extends \Magento\Framework\Model\AbstractModel implements \Magento\Framework\DataObject\IdentityInterface
{
    ...
    // const CACHE_TAG = 'training_dependencyexample_injectable';
    ...
    //  * @var string
    //  */
    // protected $_eventPrefix = 'injectable';
    ...
    // {
    //     $this->_init('Training\DependencyExample\Model\ResourceModel\Injectable');
    // }
